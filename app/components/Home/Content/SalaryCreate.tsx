...
const SalaryCreate = ({ props, setTab, tab }: any) => {
  ...
  const { users, filterUsers, loading } = useSelector(
  ...
  const [singleSalaryDate, setSingleSalaryDate] = useState(
    new Date().toISOString().split("T")[0]
  );
  const [salaryPdfDate, setSalaryPdfDate] = useState(
    new Date().toISOString().split("T")[0]
  );
  ...
  const handleSelectAll = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.checked && filterUsers) {
      setSelectedItems(filterUsers.map((user: any) => user._id)); // Assuming each user has an 'id' property
    } else {
      setSelectedItems([]);
    }
  };
  ...
  useEffect(() => {
    ...
    if (nameArray.length > 0) {
      ...
      const initialSelectedNames = saved ? JSON.parse(saved) : [...nameArray];
      setSelectedNames(initialSelectedNames);
    }
    if (idArray.length > 0) {
      const saved = localStorage.getItem("selectedIds");
      const initialSelectedIds = saved ? JSON.parse(saved) : [...idArray];
    ...
    <div className="flex  relative bg-white">
      ...
      <div className="w-[93%] px-3 pt-12">
        ...
        <div className="flex justify-between mt-5">
          <div>
            <button
              onClick={handleExcelSalary}
              className="bg-black w-8/12 text-white rounded-sm text-sm py-2 px-8 cursor-pointer"
            >
              Salary Import As Excel
            </button>
            <input
              type="date"
          ...
          <div>
            ...
            <div className="dropdown dropdown-end">
              ...
              <ul
                tabIndex={0}
                className="dropdown-content menu bg-amber-100 rounded-box z-1 w-52 p-2 shadow-sm "
              >
                <li>
                  <a
                  ...
                  <th>
                    <input
                      ...
                      checked={
                        ...
                        selectedItems.length === filterUsers.length
                      }
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {isFilter && (
                        <div className="dropdown dropdown-end">
                          ...
                          <ul
                            tabIndex={0}
                            className="dropdown-content menu bg-base-300  rounded-box z-1 w-64 p-2 shadow-sm"
                          >
                            <div className="flex items-center justify-between mt-3">
                              ...
                              >
                                Select all({idSelectedItems.length})
                              </button>
                              <button
                                className="cursor-pointer"
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    <input
                                      ...
                                      onChange={(e) =>
                                        handleIdSelect(val, e.target.checked)
                                      }
                                    />
                                  </div>
                                );
                            ...
                            <div className="flex justify-end">
                              <button
                                onClick={handleUser}
                                className="mt-4 bg-green-500 py-1 text-white text-xs rounded-sm cursor-pointer px-4 w-fit"
                              >
                                Ok
                              </button>
                              <button
                                ...
                                className="mt-4 bg-slate-400 py-1 text-white text-xs rounded-sm cursor-pointer px-4 w-fit ml-2"
                              >
                                Cancel
                              </button>
                            </div>
                        ...
                        <div className="dropdown dropdown-end">
                          ...
                          >
                            <div className="flex items-center justify-between mt-3">
                              ...
                              >
                                Select all({nameSelectedItems.length})
                              </button>
                              <button
                                className="cursor-pointer"
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    <input
                                      ...
                                      onChange={(e) =>
                                        handleNameSelect(val, e.target.checked)
                                      }
                                    />
                                  </div>
                                );
                        ...
                        <div className="dropdown dropdown-end">
                          ...
                          >
                            <div className="flex items-center justify-between mt-3">
                              ...
                              >
                                Select all({categorySelectedItems.length})
                              </button>
                              <button
                                className="cursor-pointer"
              ...
              <tbody>
                {filtedUser?.map((val: any, ind: any) => {
                  return (
                    <tr
                      key={ind}
                      onClick={() => handleHover(ind)}
                      className={`${
                        tableHover === ind ? "bg-amber-100" : ""
                      } cursor-pointer`}
                    >
                      <td>
                        <input
                      ...
                      <td onClick={() => handleSalary(val)} className="text-xl">
                        <IoCreateSharp />
                      </td>
                    </tr>
                  );
        ...
        <div className="modal-box max-w-4xl">
          ...
          <form className="mt-4" onSubmit={handleSubmit(handleSave)}>
            <div className="font-semibold text-sm">
              Employee Information (কর্মচারীর তথ্য){" "}
            </div>
            ...
            <div className="font-semibold text-sm mt-4">
              Salary Information (বেতনের তথ্য){" "}
            </div>
            <div className="flex items-center flex-wrap border-[1px] border-[#dfdddd] p-2 rounded-md mt-2">
              <div className="fieldset w-3/12">
            ...
            <div className="flex items-center flex-wrap border-[1px] border-[#dfdddd] p-2 rounded-md mt-2">
              ...
              <div className="fieldset w-3/12">
                <legend className="fieldset-legend">
                  Maternity Leave (মাতৃকালীন ছুটি)
                </legend>
                <input
                  type="number"
                  className="input w-11/12"
            ...
            <div className="font-semibold text-sm mt-4">
              Over Time (অতিরিক্ত কর্ম){" "}
            </div>
            <div className="flex items-center flex-wrap border-[1px] border-[#dfdddd] p-2 rounded-md mt-2">
              <div className="fieldset w-3/12">
                <legend className="fieldset-legend">
                  OT Hours (অতিরিক্ত কর্মঘন্টা)
                </legend>
                <input
                  type="number"
                  className="input w-11/12"
              ...
              <div className="fieldset w-3/12">
                <legend className="fieldset-legend">
                  Over Time Rate (অতিরিক্ত কর্মহার)
                </legend>
                <input
                  type="number"
                  className="input w-11/12"
            ...
            <button className="bg-black text-white px-8 py-2 mt-5 cursor-pointer rounded-sm">
              {singleSalaryLoading ? (
      ...
      <dialog id="my_modal_3" className="modal w-full">
        <div className="modal-box max-w-4xl w-ful">
          ...
          <div className="flex justify-between items-center mt-3">
            ...
            />
            <button
              onClick={excelSalaryCreate}
              className="bg-black rounded-lg text-white px-8 py-2 cursor-pointer"
            >
              {salaryLoading ? (
                <span className="loading loading-spinner loading-md"></span>
              ) : (
          ...
          <p className="text-xs text-pink-400 mt-2">
            [NB: Sample Salary Excel Found From Settings]
          </p>
          ...
          <div className="border-2 border-[#f1f1f1] mt-5 rounded-sm">
            <div className="overflow-x-auto overflow-y-auto">
              <table className="table table-sm">
                ...
                <tbody>
                  {jsonData &&
                    jsonData.slice(0, 10).map((val: any, ind: any) => {
                      return (
                        <tr
                          key={ind}
                          className={`${
                            excelTableHover === ind && "bg-amber-100"
                          }`}
                          onClick={() => setExcelHover(ind)}
                        >
                          <th>{ind + 1}</th>
                          <th>{val.Name}</th>
                          <th>{val.ID}</th>
