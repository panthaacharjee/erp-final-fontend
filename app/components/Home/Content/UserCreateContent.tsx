...
import { ClearSuccess, ClearUserError, ClearUserSuccess, UserCreateAndUpdateFail, UserCreateAndUpdateRequest, UserCreateAndUpdateSuccess } from '@/app/redux/reducers/HrReducer'
...
const UserCreateContent = ({props, setTab, tab}:any) => {
  ...
  const {user,  success, error, message, loading} = useSelector((state:RootState)=>state.hr)
  console.log(error)
  ...
  useEffect(() => {
    ...
    if(success){
      ...
      setValue('district', user?.address?.district ?  user.address.district : '')
      setValue('father', user?.personalInformation?.father ?  user.personalInformation.father : '')
      setValue('mother', user?.personalInformation?.mother ?  user.personalInformation.mother : '')
      setValue('blood', user?.personalInformation?.blood ?  user.personalInformation.blood : 'Pick a Category')
      setValue('nid', user?.personalInformation?.nid ?  user.personalInformation.nid : '')
      setValue('dob', user?.personalInformation?.dob ?  new Date(user.personalInformation.dob).toISOString().split("T")[0]: new Date().toISOString().split("T")[0] as any)
      setValue('phone', user?.personalInformation?.phone ?  user.personalInformation.phone : '')
      setValue('qualification', user?.education?.qualification ?  user.education.qualification : '')
      setValue('nomineeName', user?.nominee?.name ?  user.nominee.name : '')
      setValue('relation', user?.nominee?.relation ?  user.nominee.relation : '')
            ...
            <form onSubmit={handleSubmit(handleSave)} className='w-[93%] px-3 pt-12'>
                  ...
                  <div className="collapse-content text-sm">
                      <div className='flex items-center flex-wrap'>
                        <div className="fieldset w-3/12">
                          ...
                          <input  
                              type="text" 
                              className={`${errors.employeeId ? 'input w-11/12 border-red-400':'input w-11/12'}`}  
                        ...
                        <div className="fieldset w-3/12">
                          ...
                          <input 
                            ...
                            className={`${errors.name ? 'input w-11/12 border-red-400':'input w-11/12 '}`}  
                            {...register("name")}
                          />
                        </div>
                        <div className="fieldset w-3/12">
                          <legend className="fieldset-legend">Username (সফটওয়্যার নাম)</legend>
                          <input 
                            type="text" 
                         ...
                         <div className="fieldset w-3/12">
                          <legend className="fieldset-legend">Password (সফটওয়্যার পাসওয়ার্ড)</legend>
                        ...
                        <div className="fieldset w-3/12">
                          ...
                          <select {...register("category")} defaultValue="P" className="select w-11/12">
                        ...
                        <div className="fieldset w-3/12 ">
                          <legend className="fieldset-legend">Join Date (যোগদানের তারিখ)</legend>
                          <input 
                            type="date" 
                            className="input w-11/12" 
                            {...register("joinDate")}
                ...
                <div className="collapse collapse-plus bg-base-100 border border-base-300">
                  ...
                  <div className="collapse-content text-sm">
                      <div className='flex items-center flex-wrap'>
                        ...
                        <div className="fieldset w-3/12">
                          <legend className="fieldset-legend">Home Rent (বাড়ি ভাড়া)</legend>
                          <input 
                            type="number" 
                            className="input w-11/12" 
                         ...
                         <div className="fieldset w-3/12">
                          <legend className="fieldset-legend">Medical Allowence (চিকিৎসা ভাতা)</legend>
                          <input 
                            type="number" 
                            className="input w-11/12" 
                        ...
                        <div className="fieldset w-3/12">
                          <legend className="fieldset-legend">Conveyance Allowence (যাতায়াত ভাতা)</legend>
                          <input 
                            type="number" 
                            className="input w-11/12" 
                ...
                <div className="collapse collapse-plus bg-base-100 border border-base-300">
                  ...
                  <div className="collapse-content text-sm">
                      <div className='flex items-center flex-wrap'>
                        <div className="fieldset w-3/12">
                          <legend className="fieldset-legend">Father Name (বাবার নাম)</legend>
                          <input 
                            type="text" 
                            className="input w-11/12" 
                        ...
                        <div className="fieldset w-3/12">
                          <legend className="fieldset-legend">Mother Name (মায়ের নাম)</legend>
                          <input 
                            type="text" 
                            className="input w-11/12" 
                        ...
                        <div className="fieldset w-3/12">
                          <legend className="fieldset-legend">Date of Birth (জন্ম তারিখ)</legend>
                          <input 
                            type="date" 
                            className="input w-11/12"
                            {...register("dob")} 
                         ...
                         <div className="fieldset w-3/12">
                          <legend className="fieldset-legend">Blood Group (রক্তের গ্রুপ)</legend>
                          <select {...register("blood")} defaultValue={user?.personalInformation?.blood ? user.personalInformation.blood : 'Pick a Group'} className="select w-11/12">
                         ...
                         <div className="fieldset w-3/12">
                          <legend className="fieldset-legend">NID (এনআইডি নাম্বার)</legend>
                          <input 
                            type="text" 
                            className="input w-11/12"
                        ...
                        <div className="fieldset w-3/12">
                         ...
                         <div className="fieldset w-3/12">
                          <legend className="fieldset-legend">Profile (কর্মচারীর ছবি)</legend>
                ...
                <div className="collapse collapse-plus bg-base-100 border border-base-300">
                  ...
                  <div className="collapse-content text-sm">
                      <div className='flex items-center flex-wrap'>
                        ...
                        <div className="fieldset w-3/12">
                          <legend className="fieldset-legend">Thana/Upazilla (থানা/উপজিলা)</legend>
                          <input 
                            type="text" 
                            className="input w-11/12" 
                         ...
                         <div className="fieldset w-3/12">
                          <legend className="fieldset-legend">Post Office (পোস্ট অফিস)</legend>
                          <input 
                            type="text" 
                            className="input w-11/12" 
                        ...
                        <div className="fieldset w-3/12">
                          <legend className="fieldset-legend">Post Code (পোস্ট কোড)</legend>
                          <input 
                            type="text" 
                            className="input w-11/12" 
                 ...
                 <div className="collapse collapse-plus bg-base-100 border border-base-300">
                  ...
                  <div className="collapse-content text-sm">
                      <div className='flex items-center flex-wrap'>
                        <div className="fieldset w-3/12">
                          <legend className="fieldset-legend">Bank Name (ব্যাংকের নাম)</legend>
                          <input 
                            type="text" 
                            className="input w-11/12" 
                        ...
                        <div className="fieldset w-3/12">
                          <legend className="fieldset-legend">Account Number (একাউন্ট নাম্বার)</legend>
                          <input 
                            type="text" 
                            className="input w-11/12" 
                         ...
                         <div className="fieldset w-3/12">
                          <legend className="fieldset-legend">Routing Number (রাউটিং নাম্বার)</legend>
                          <input 
                            type="text" 
                            className="input w-11/12" 
                        ...
                        <div className="fieldset w-3/12">
                          <legend className="fieldset-legend">Nominee Name (নমিনির নাম)</legend>
                          <input 
                            type="text" 
                            className="input w-11/12" 
                        ...
                        <div className="fieldset w-3/12">
                          <legend className="fieldset-legend">Nominee Relation (সম্পর্ক)</legend>
                          <select {...register('relation')} defaultValue="Pick a group" className="select w-11/12">
                 ...
                 <div className="collapse collapse-plus bg-base-100 border border-base-300">
                  ...
                  <div className="collapse-content text-sm">
                    <div className='flex items-center flex-wrap'>
                        <div className="fieldset w-3/12">
                          <legend className="fieldset-legend">Qualification (যোগ্যতা)</legend>
                          <input 
                            type="text" 
                            className="input w-11/12" 
                        ...
                        <div className="fieldset w-3/12">
                          <legend className="fieldset-legend">Certificate (সার্টিফিকেট)</legend>
                          <input type="file" className="file-input w-11/12" />
                        </div>
                      </div>
                  </div>
...
// const UserCreateContent = ({data}:any) => {
//   console.log(data)
//   return (
//     <div>
//       <Sample/>
