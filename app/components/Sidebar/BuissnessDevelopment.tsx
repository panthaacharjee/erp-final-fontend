...
import { BusinessDevelopmentData, HrandAdminData, ProductDevelopmentData } from './SidebarData';
...
const BusinessDevelopment = ({setSidebar, setSelected, setTab}:any) => {
    ...
    <div className='px-4 py-8 relative'>
        ...
        <div className='flex'>
          <div className='w-[230px]'>
            ...
            <div className='mt-5'>
                <div onClick={()=>setupFunc(BusinessDevelopmentData[0])} className=' sidebar-content-div hover:bg-[#13a7ec] flex justify-between items-center  bg-black text-white uppercase font-semibold w-full px-4 py-2 rounded-lg  shadow-md'>
                  <p className='text-xl'><IoIosBusiness/></p>
                  <p className='ml-2 text-xs cursor-default'>Organization Create</p>
                  <p className=' sidebar-content-div-p text-md hover:text-yellow-300 cursor-pointer'><FaStar/></p>
                </div>
                <div onClick={()=>setupFunc(BusinessDevelopmentData[1])} className=' sidebar-content-div hover:bg-[#13a7ec] flex justify-between items-center  bg-black text-white uppercase font-semibold w-full px-4 py-2 rounded-lg  mt-4 shadow-md'>
                  <p className='text-xl'><FcViewDetails/></p>
                  <p className='ml-2 text-xs cursor-default'>Product Details</p>
                  <p className=' sidebar-content-div-p text-md hover:text-yellow-300 cursor-pointer'><FaStar/></p>
                </div>
                <div onClick={()=>setupFunc(BusinessDevelopmentData[2])} className=' sidebar-content-div hover:bg-[#13a7ec] flex justify-between items-center  bg-black text-white uppercase font-semibold w-full px-4 py-2 rounded-lg  mt-4 shadow-md'>
                  <p className='text-xl'><FcProcess/></p>
                  <p className='ml-2 text-xs cursor-default'>Product Process</p>
                  <p className=' sidebar-content-div-p text-md hover:text-yellow-300 cursor-pointer'><FaStar/></p>
                </div>
            </div>
          </div>
          ...
          <div className='w-[230px]'>
            <p className='text-white text-xs font-bold uppercase text-center'>Reports</p>
                <div onClick={()=>reportFunc()} className='flex justify-between items-center  bg-white text-black uppercase font-semibold w-full px-4 py-2 rounded-lg shadow-md mt-6'>
                    ...
                    <p className='ml-2 text-xs cursor-default'>Business Report</p>
